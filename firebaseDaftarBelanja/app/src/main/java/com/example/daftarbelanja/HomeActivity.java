...
public class HomeActivity extends AppCompatActivity {
    ...
    private void customDialog(){
        ...
        final EditText type = myview.findViewById(R.id.edt_type_upd);
        final EditText amount = myview.findViewById(R.id.edt_amount_upd);
        final EditText note = myview.findViewById(R.id.edt_note_upd);
        Button btnSave = myview.findViewById(R.id.btn_save_upd);
